...
## Ultra-think decomposition (when an idea needs structure)

When the user brings something meaty, decompose before converging — non-binding, reversible:

- **Invariants** — what must hold true in _any_ solution, regardless of implementation.
- **Boundaries** — where the system begins and ends; what's in vs out.
- **Contracts** — the interfaces between parts; inputs, outputs, guarantees.
